...
public class RevlogTest {
    ...
    public void testEncodeFname() {
        assertEquals("data/test", org.hg4j.core.NodeIdUtil.encodeFname("test"));
        assertEquals("data/~2etest", org.hg4j.core.NodeIdUtil.encodeFname(".test"));
        assertEquals("data/test__with__underscores", org.hg4j.core.NodeIdUtil.encodeFname("test_with_underscores"));
        assertEquals("data/au~78", org.hg4j.core.NodeIdUtil.encodeFname("aux"));
        assertEquals("data/au~78.i", org.hg4j.core.NodeIdUtil.encodeFname("aux.i"));
        assertEquals("data/_c_o_n", org.hg4j.core.NodeIdUtil.encodeFname("CON"));
        assertEquals("data/com~35", org.hg4j.core.NodeIdUtil.encodeFname("com5"));
        assertEquals("data/test space", org.hg4j.core.NodeIdUtil.encodeFname("test space"));
        assertEquals("data/~2ehello world", org.hg4j.core.NodeIdUtil.encodeFname(".hello world"));
        
        // Non-ASCII Korean encoding verification
        String encodedKorean = org.hg4j.core.NodeIdUtil.encodeFname("안녕");
