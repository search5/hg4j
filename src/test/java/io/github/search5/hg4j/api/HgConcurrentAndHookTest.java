...
import io.github.search5.hg4j.revwalk.*;
...
public class HgConcurrentAndHookTest {
    ...
    public void testNewHooksTriggered() throws Exception {
        ...
        hg.update().setRevision(io.github.search5.hg4j.core.NodeIdUtil.toHex(firstCommit)).setForce(true).call();
        ...
        GraftCommand graftCmd = hg.graft().setSource(io.github.search5.hg4j.core.NodeIdUtil.toHex(firstCommit));
        try {
            graftCmd.call();
    ...
    public void testRevsetEngineAndOrEdgeCases() throws Exception {
        ...
        io.github.search5.hg4j.core.HgRevsetEngine engine = new io.github.search5.hg4j.core.HgRevsetEngine(repo);
    ...
    public void testRealHttpRoundtrip() throws Exception {
        ...
        String commitNodeHex = io.github.search5.hg4j.core.NodeIdUtil.toHex(commitNode);
        
        io.github.search5.hg4j.core.ChangegroupParser.ChangegroupBundle bundle = io.github.search5.hg4j.HgTestUtils.createMockBundleFromRepo(srcRepo);
        byte[] realCgBytes = io.github.search5.hg4j.HgTestUtils.serializeBundleToBytes(bundle);
        ...
        try {
            ...
            io.github.search5.hg4j.transport.HgRemoteClient client = new io.github.search5.hg4j.transport.HgRemoteClient(httpUrl);
    ...
    public void testRealSshRoundtrip() throws Exception {
        ...
        try {
            ...
            io.github.search5.hg4j.transport.HgSshClient client = new io.github.search5.hg4j.transport.HgSshClient(sshUrl);
            ...
            fetch.setCredentialsProvider(new io.github.search5.hg4j.transport.CredentialsProvider() {
                @Override
                public boolean get(String uri, io.github.search5.hg4j.transport.CredentialItem... items) {
                    for (io.github.search5.hg4j.transport.CredentialItem item : items) {
                        if (item instanceof io.github.search5.hg4j.transport.CredentialItem.Password) {
                            ((io.github.search5.hg4j.transport.CredentialItem.Password) item).setValue("any_password".toCharArray());
                        } else if (item instanceof io.github.search5.hg4j.transport.CredentialItem.Username) {
                            ((io.github.search5.hg4j.transport.CredentialItem.Username) item).setValue("testuser");
                        }
                    }
                    return true;
                }
    ...
    public void testNativeMercurialLocalBundleInteroperability() throws Exception {
        ...
        if (bundleBytes.length >= 4 && bundleBytes[0] == 'H' && bundleBytes[1] == 'G' && bundleBytes[2] == '2' && bundleBytes[3] == '0') {
            io.github.search5.hg4j.core.Bundle2Parser.ExtractedBundle2 ext = io.github.search5.hg4j.core.Bundle2Parser.extractChangegroupDetailed(new java.io.ByteArrayInputStream(bundleBytes));
        ...
        io.github.search5.hg4j.core.ChangegroupParser.ChangegroupBundle bundle = io.github.search5.hg4j.core.ChangegroupParser.parseBundle(new java.io.ByteArrayInputStream(changegroupBytes), cgVersion);
        FetchCommand fetch = new FetchCommand(destRepo);
