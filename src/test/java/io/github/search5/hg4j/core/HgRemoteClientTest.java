...
import io.github.search5.hg4j.transport.HgWireServer;
import java.io.File;
...
public class HgRemoteClientTest {
    ...
    public void testMercurialChunkedInputStreamUnwrapsCorrectly() throws Exception {
        ...
        // Create unwrapper
        java.lang.reflect.Constructor<?> constructor = Class.forName("io.github.search5.hg4j.transport.HgRemoteClient$MercurialChunkedInputStream")
    ...
    public void testEncodeExtraKeyColons() {
        ...
        String encoded = io.github.search5.hg4j.api.CommitCommand.encodeExtraKey(testInput);
        assertTrue(encoded.contains("\\:"));
        assertTrue(encoded.contains("\\\\"));
        
        String decoded = io.github.search5.hg4j.api.CommitCommand.decodeExtraKey(encoded);
        ...
        int unescapedIdx = io.github.search5.hg4j.api.CommitCommand.findUnescapedColon(part);
    ...
    public void testHgRemoteClientMalformedUrlException() {
        ...
        io.github.search5.hg4j.errors.HgTransportException ex = assertThrows(io.github.search5.hg4j.errors.HgTransportException.class, () -> client.getHeads());
    ...
    public void testMercurialChunkedInputStreamNegativeLengthException() throws Exception {
        ...
        assertThrows(io.github.search5.hg4j.errors.HgProtocolException.class, () -> chunkedStream.read());
    }
    ...
    public void testUnwrapResponseStreamUnsupportedCompressionException() throws Exception {
        ...
        assertThrows(io.github.search5.hg4j.errors.HgProtocolException.class, () -> {
            try {
