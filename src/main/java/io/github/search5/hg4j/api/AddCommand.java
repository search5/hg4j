...
public class AddCommand {
    ...
    public void call() throws IOException {
        try (io.github.search5.hg4j.core.HgLock wlock = repository.lockWorkingCopy()) {
            ...
            for (String relPath : filesToAdd) {
                ...
                if (!diskFile.exists() || !diskFile.isFile()) {
                    throw new io.github.search5.hg4j.errors.HgValidationException("File not found or is not a standard file: " + relPath);
                }
