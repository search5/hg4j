...
import org.hg4j.revwalk.*;
import org.hg4j.treewalk.ManifestWalk;
import org.hg4j.treewalk.WorkingDirWalk;
...
public class HgConcurrentAndHookTest {
    ...
    public void testRevsetEngineAndOrEdgeCases() throws Exception {
        ...
        org.hg4j.core.HgRevsetEngine engine = new org.hg4j.core.HgRevsetEngine(repo);
    ...
    public void testRealHttpRoundtrip() throws Exception {
        ...
        String commitNodeHex = org.hg4j.core.NodeIdUtil.toHex(commitNode);
        
        org.hg4j.core.ChangegroupParser.ChangegroupBundle bundle = org.hg4j.HgTestUtils.createMockBundleFromRepo(srcRepo);
        byte[] realCgBytes = org.hg4j.HgTestUtils.serializeBundleToBytes(bundle);
        ...
        try {
            ...
            org.hg4j.transport.HgRemoteClient client = new org.hg4j.transport.HgRemoteClient(httpUrl);
    ...
    public void testRealSshRoundtrip() throws Exception {
        ...
        try {
            ...
            org.hg4j.transport.HgSshClient client = new org.hg4j.transport.HgSshClient(sshUrl);
            ...
            fetch.setCredentialsProvider(new org.hg4j.transport.CredentialsProvider() {
                @Override
                public boolean get(String uri, org.hg4j.transport.CredentialItem... items) {
                    for (org.hg4j.transport.CredentialItem item : items) {
                        if (item instanceof org.hg4j.transport.CredentialItem.Password) {
                            ((org.hg4j.transport.CredentialItem.Password) item).setValue("any_password".toCharArray());
                        } else if (item instanceof org.hg4j.transport.CredentialItem.Username) {
                            ((org.hg4j.transport.CredentialItem.Username) item).setValue("testuser");
                        }
                    }
                    return true;
                }
    ...
    public void testNativeMercurialLocalBundleInteroperability() throws Exception {
        ...
        if (bundleBytes.length >= 4 && bundleBytes[0] == 'H' && bundleBytes[1] == 'G' && bundleBytes[2] == '2' && bundleBytes[3] == '0') {
            org.hg4j.core.Bundle2Parser.ExtractedBundle2 ext = org.hg4j.core.Bundle2Parser.extractChangegroupDetailed(new java.io.ByteArrayInputStream(bundleBytes));
        ...
        org.hg4j.core.ChangegroupParser.ChangegroupBundle bundle = org.hg4j.core.ChangegroupParser.parseBundle(new java.io.ByteArrayInputStream(changegroupBytes), cgVersion);
        FetchCommand fetch = new FetchCommand(destRepo);
