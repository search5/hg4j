...
public class Bundle2Parser {
    ...
    public static ExtractedBundle2 extractChangegroupDetailed(InputStream in) throws IOException {
        ...
        if (!"HG20".equals(magicStr)) {
            throw new io.github.search5.hg4j.errors.HgCorruptDataException("Unsupported bundle magic: " + magicStr + ". Expected HG20.");
        }
        ...
        if (compression != null && !compression.isEmpty()) {
            if ("GZ".equalsIgnoreCase(compression)) {
                ...
                throw new io.github.search5.hg4j.errors.HgCorruptDataException("Unsupported bundle2 compression: " + compression);
            }
        }
        ...
        while (true) {
            ...
            while (true) {
                ...
                if (chunkSize == -1) {
                    ...
                    throw new io.github.search5.hg4j.errors.HgCorruptDataException("Nested stream interrupts are not supported in this lightweight parser.");
                }
        ...
        if (cgOut.size() == 0) {
            throw new io.github.search5.hg4j.errors.HgCorruptDataException("No CHANGEGROUP part found in the bundle2 stream.");
        }
