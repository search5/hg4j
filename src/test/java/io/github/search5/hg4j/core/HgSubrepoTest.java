...
public class HgSubrepoTest {
    ...
    public void testSubrepoRecursiveCheckoutDuringUpdate() throws Exception {
        ...
        io.github.search5.hg4j.core.HgRepository childRepo = io.github.search5.hg4j.api.Hg.init().setDirectory(childDir).call();
        try (io.github.search5.hg4j.api.Hg hgChild = io.github.search5.hg4j.api.Hg.wrap(childRepo)) {
            ...
            String childCommitHex = io.github.search5.hg4j.core.NodeIdUtil.toHex(childCommitNode);

            // 2. Initialize parent repo
            io.github.search5.hg4j.core.HgRepository parentRepo = io.github.search5.hg4j.api.Hg.init().setDirectory(parentDir).call();
            try (io.github.search5.hg4j.api.Hg hgParent = io.github.search5.hg4j.api.Hg.wrap(parentRepo)) {
                ...
                hgParent.update().setRevision(io.github.search5.hg4j.core.NodeIdUtil.toHex(parentCommitNode)).setForce(true).call();
