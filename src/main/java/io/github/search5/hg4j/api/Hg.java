...
public class Hg implements AutoCloseable {
    ...
    private final io.github.search5.hg4j.core.HgRepository repository;
    private final java.util.Map<HgHookType, java.util.List<HgHook>> hooks = new java.util.concurrent.ConcurrentHashMap<>();
    
    private Hg(io.github.search5.hg4j.core.HgRepository repository) {
    ...
    /**
     * Wraps an existing {@link io.github.search5.hg4j.core.HgRepository} instance into the {@link Hg} facade.
     * 
     * @param repository the repository instance to wrap
     * @return the {@link Hg} facade instance
     */
    public static Hg wrap(io.github.search5.hg4j.core.HgRepository repository) {
        if (repository == null) {
    ...
    public static Hg open(java.io.File directory) throws java.io.IOException {
        ...
        if (!hgDir.exists() || !hgDir.isDirectory()) {
            throw new io.github.search5.hg4j.errors.HgRepositoryNotFoundException("Repository not found at: " + directory.getAbsolutePath());
        }
            ...
            if (reqFile.exists()) {
                for (String line : java.nio.file.Files.readAllLines(reqFile.toPath())) {
                    ...
                    if (!SUPPORTED.contains(r) && !SUPPORTED.contains(key)) {
                        throw new io.github.search5.hg4j.errors.HgValidationException("unsupported repository requirement: " + r);
                    }
                }
            }
        }

        return new Hg(new io.github.search5.hg4j.core.HgRepository(directory));
    }
    ...
    public io.github.search5.hg4j.core.HgRepository getRepository() {
     ...
     */
    public io.github.search5.hg4j.core.HgRcConfig config() {
        io.github.search5.hg4j.core.HgRcConfig cfg = new io.github.search5.hg4j.core.HgRcConfig();
        try {
     ...
     */
    public java.util.List<DiffCommand.DiffEntry> getDiff(io.github.search5.hg4j.lib.NodeId oldRevision, io.github.search5.hg4j.lib.NodeId newRevision) throws java.io.IOException {
        return diff().setOldRevision(oldRevision).setNewRevision(newRevision).call();
    }
     ...
     */
    public java.util.List<TreeCommand.TreeEntry> getTree(io.github.search5.hg4j.lib.NodeId revision) throws java.io.IOException {
        return tree().setNodeId(revision).call();
    }

    public io.github.search5.hg4j.treewalk.ManifestWalk walkManifest(String revision) {
        return new io.github.search5.hg4j.treewalk.ManifestWalk(this.repository, revision);
    }

    public io.github.search5.hg4j.treewalk.WorkingDirWalk walkWorkingDir() {
        return new io.github.search5.hg4j.treewalk.WorkingDirWalk(this.repository);
    }

    /**
     * Returns a new TreeWalk instance for advanced parallel sorted traversal of multiple trees.
     */
    public io.github.search5.hg4j.treewalk.TreeWalk walkTree() {
        return new io.github.search5.hg4j.treewalk.TreeWalk();
    }
