...
public class HgRevsetTest {
    ...
    public void testRevsetEngineValidation() throws Exception {
        ...
        io.github.search5.hg4j.core.HgRepository repo = io.github.search5.hg4j.api.Hg.init().setDirectory(tempDir).call();
        
        try (io.github.search5.hg4j.api.Hg hg = io.github.search5.hg4j.api.Hg.wrap(repo)) {
