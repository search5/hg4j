    ...
    private void loadEntries() throws IOException {
        ...
        if (directManifestNode != null) {
            ...
            if (targetNodeId == null) {
                throw new io.github.search5.hg4j.errors.HgRevisionNotFoundException("Revision not found in changelog: " + revision);
            }

            int commitRev = NodeIdUtil.findRevisionByNodeId(changelog, targetNodeId);
            if (commitRev == -1) {
                throw new io.github.search5.hg4j.errors.HgRevisionNotFoundException("Commit not found in changelog for node: " + NodeIdUtil.toHex(targetNodeId));
            }
