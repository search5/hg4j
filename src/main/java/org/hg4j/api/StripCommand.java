...
public class StripCommand {
    ...
    public void call() throws IOException {
        ...
        try (org.hg4j.core.HgLock storeLock = repository.lockStore();
            ...
            org.hg4j.core.SafeFileIO.writeLinesAtomic(fncacheFile, updatedFncachePaths);
            ...
            if (bookmarksFile.exists()) {
                ...
                for (String line : bLines) {
                    ...
                    if (parts.length == 2) {
                        ...
                        byte[] node = org.hg4j.core.NodeIdUtil.fromHex(hexNode);
                ...
                if (updatedBLines.isEmpty()) {
                    ...
                    org.hg4j.core.SafeFileIO.writeLinesAtomic(bookmarksFile, updatedBLines);
                }
            }
            ...
            if (phaserootsFile.exists()) {
                ...
                if (updatedPLines.isEmpty()) {
                    ...
                    org.hg4j.core.SafeFileIO.writeLinesAtomic(phaserootsFile, updatedPLines);
                }
            }
