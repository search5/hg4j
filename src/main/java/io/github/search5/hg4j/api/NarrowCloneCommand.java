...
import io.github.search5.hg4j.core.HgTreeFilter;
...
public final class NarrowCloneCommand {
    ...
    public Hg call() throws IOException {
        ...
        io.github.search5.hg4j.core.SafeFileIO.writeLinesAtomic(requiresFile, requirements);
        ...
        io.github.search5.hg4j.core.SafeFileIO.writeStringAtomic(narrowSpecFile, sb.toString());
