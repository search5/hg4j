...
public class StatusCommand {
    ...
    public StatusCommand setTreeFilter(io.github.search5.hg4j.core.HgTreeFilter treeFilter) {
        if (treeFilter != null) {
    ...
    public Status call() throws IOException {
        ...
        if (treeFilter == null || treeFilter == io.github.search5.hg4j.core.HgTreeFilter.ALL) {
            ...
            trackedKeys.sort(io.github.search5.hg4j.core.NodeIdUtil.UTF8_STRING_COMPARATOR);
            ...
            untrackedList.sort(io.github.search5.hg4j.core.NodeIdUtil.UTF8_STRING_COMPARATOR);
        ...
        tw.addTree(new io.github.search5.hg4j.treewalk.ManifestTreeIterator(repository, parentRev));
        tw.addTree(new io.github.search5.hg4j.treewalk.WorkingDirTreeIterator(repository));
