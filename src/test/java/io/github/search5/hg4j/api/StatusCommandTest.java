...
public class StatusCommandTest {
    ...
    public void testStatusCommandTreeFilter(@TempDir Path tempDir) throws Exception {
        ...
        io.github.search5.hg4j.core.HgTreeFilter filter = io.github.search5.hg4j.core.HgTreeFilter.createPathPrefixFilter(java.util.List.of("src/"), java.util.List.of());
    ...
    public void testFastPathVsSlowPath(@TempDir Path tempDir) throws Exception {
        ...
        Status fastStatus = new StatusCommand(repo).setTreeFilter(io.github.search5.hg4j.core.HgTreeFilter.ALL).call();

        // 3. Slow Path로 Status 호출 (custom filter를 써서 treeFilter == ALL 조건 우회)
        io.github.search5.hg4j.core.HgTreeFilter customFilter = new io.github.search5.hg4j.core.HgTreeFilter() {
            @Override
