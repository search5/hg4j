...
public class HgPorcelainAndExceptionsTest {
    ...
    public void testHgValidationException() {
        io.github.search5.hg4j.errors.HgValidationException ex1 = new io.github.search5.hg4j.errors.HgValidationException("val error");
        assertEquals("val error", ex1.getMessage());
        
        Throwable cause = new RuntimeException("cause");
        io.github.search5.hg4j.errors.HgValidationException ex2 = new io.github.search5.hg4j.errors.HgValidationException("val error 2", cause);
    ...
    public void testCatCommandEdgeCases() throws Exception {
        ...
        cat.setRevision(new io.github.search5.hg4j.lib.NodeId(revNode));
        assertArrayEquals("Hello Cat\n".getBytes(), cat.call());

        // setRevision(NodeId null) 테스트
        cat.setRevision((io.github.search5.hg4j.lib.NodeId) null);
        assertArrayEquals("Hello Cat\n".getBytes(), cat.call()); // defaults to tip

        // 3. Revision not found
        cat.setRevision("non_existent_branch_123");
        assertThrows(io.github.search5.hg4j.errors.HgRevisionNotFoundException.class, cat::call);
        ...
        cat.setRevision(new io.github.search5.hg4j.lib.NodeId(revNode));
        assertThrows(io.github.search5.hg4j.errors.HgCorruptDataException.class, cat::call);
    }
    ...
    public void testHgOpenRequiresValidationAndWrap(@TempDir java.nio.file.Path tempDir) throws Exception {
        ...
        io.github.search5.hg4j.core.HgRepository repo = Hg.init().setDirectory(repoDir).call();
    ...
    public void testJavaScmHookSystemIntegration(@TempDir java.nio.file.Path tempDir) throws Exception {
        ...
        try (Hg hg = Hg.wrap(repo)) {
            ...
            assertThrows(io.github.search5.hg4j.errors.HgValidationException.class, rejectCommit::call);
    ...
    public void testDynamicZstdCompressionIntegration(@TempDir java.nio.file.Path tempDir) throws Exception {
        ...
        io.github.search5.hg4j.core.HgRepository zstdRepo = Hg.init()
        ...
        io.github.search5.hg4j.core.HgRepository normalRepo = Hg.init()
