    ...
    public static Map<String, HgSubrepoEntry> parseSubrepositories(byte[] hgsubContent, byte[] hgsubstateContent) throws IOException {
        ...
        if (hgsubContent != null && hgsubContent.length > 0) {
            ...
            for (String line : lines) {
                ...
                if (eqIdx == -1) {
                    throw new io.github.search5.hg4j.errors.HgCorruptDataException("Malformed .hgsub entry: missing '=' symbol");
                }
        ...
        if (hgsubstateContent != null && hgsubstateContent.length > 0) {
            ...
            for (String line : lines) {
                ...
                if (spaceIdx == -1) {
                    throw new io.github.search5.hg4j.errors.HgCorruptDataException("Malformed .hgsubstate entry: missing space between hash and path");
                }
