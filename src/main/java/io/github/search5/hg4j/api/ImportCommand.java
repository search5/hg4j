...
public class ImportCommand {
    ...
    public void call() throws IOException {
        ...
        for (java.util.Map.Entry<String, String> fEntry : patchedFiles.entrySet()) {
            ...
            manifestMap.put(path, io.github.search5.hg4j.core.NodeIdUtil.toHex(newFileNode)); // default flag is empty
        }
        ...
        try (io.github.search5.hg4j.core.HgLock storeLock = repository.lockStore();
            ...
            io.github.search5.hg4j.core.Dirstate d = repository.getDirstate();
