...
public class EscapeAndMetadataTest {
    ...
    public void testGcCommandWithMetadataFiles(@TempDir Path tempDir) throws Exception {
        ...
        io.github.search5.hg4j.core.HgRepository repo = io.github.search5.hg4j.api.Hg.init().setDirectory(repoDir).call();
        ...
        // 4. GcCommand 실행
        io.github.search5.hg4j.api.GcCommand gc = new io.github.search5.hg4j.api.GcCommand(repo);
